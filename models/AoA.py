...
class AoAModel(AttModel):
    ...
    def _prepare_feature(self, fc_feats, att_feats, att_masks, ocr_feats, ocr_masks):
        ...
        # att_feats = torch.cat([att_feats, ocr_feats], dim=1)
        # att_masks = torch.cat([att_masks, ocr_masks], dim=1)
        ...
        return mean_feats, att_feats, p_att_feats, att_masks, ocr_feats, ocr_masks