...
class ShowAttTellCatCore(nn.Module):
    def __init__(self, opt, use_maxout=False):
        super(ShowAttTellCatCore, self).__init__()
...
class ShowAttTellCatModel(AttModel):
    def __init__(self, opt):
        super(ShowAttTellCatModel, self).__init__(opt)
        self.num_layers = 2
        self.core = ShowAttTellCatCore(opt)