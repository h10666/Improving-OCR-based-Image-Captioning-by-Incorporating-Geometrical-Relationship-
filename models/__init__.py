...
from .AttCatModel import *
from .TransformerModel import TransformerModel
from .ShowAttTellModel import ShowAttTellModel
from .ShowAttTellCatModel import ShowAttTellCatModel
from .AoA import AoAModel
...
def setup(opt):
    ...
    elif opt.caption_model == 'show_attend_tell_cat':
        model = ShowAttTellCatModel(opt)
    ...
    # Top-down attention model
    elif opt.caption_model == 'topdowncat':
        model = TopDownCatModel(opt)
    # StackAtt
